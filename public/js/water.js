...
(function () {
  ...
  (function carousel() {
    ...
    function sync() {
      ...
      if (bar) {
        ...
        bar.style.transform =
          "translateX(" + ratio * (100 / Math.max(visible, 0.0001) - 100) + "%)";
      }
    }
    ...
    function frame() {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        for (var x = 0; x <= w; x += 14) {
          var y =
            yBase +
            Math.sin(x * 0.006 + t * (1.2 + i * 0.5)) * amp +
  ...
  waterCanvas(document.getElementById("ripple-canvas"), {
    host: document.querySelector(".hero-x"),
  });
